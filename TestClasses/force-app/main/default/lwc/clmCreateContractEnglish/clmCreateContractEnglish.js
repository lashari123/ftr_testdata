...
import { OMNIDEF } from './clmCreateContractEnglish_def.js';
import tmpl from './clmCreateContractEnglish.html';
import tmpl_nds from './clmCreateContractEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class clmCreateContractEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
