...
import { OMNIDEF } from './quoteQuickQuoteEnglish_def.js';
import tmpl from './quoteQuickQuoteEnglish.html';
import tmpl_nds from './quoteQuickQuoteEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class quoteQuickQuoteEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
