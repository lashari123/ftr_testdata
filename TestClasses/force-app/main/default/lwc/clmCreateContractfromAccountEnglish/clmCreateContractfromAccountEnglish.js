...
import { OMNIDEF } from './clmCreateContractfromAccountEnglish_def.js';
import tmpl from './clmCreateContractfromAccountEnglish.html';
import tmpl_nds from './clmCreateContractfromAccountEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class clmCreateContractfromAccountEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
