...
import { OMNIDEF } from './clmCreateContractForMDUEnglish_def.js';
import tmpl from './clmCreateContractForMDUEnglish.html';
import tmpl_nds from './clmCreateContractForMDUEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class clmCreateContractForMDUEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
