...
import { OMNIDEF } from './fSACreateAgreementEnglish_def.js';
import tmpl from './fSACreateAgreementEnglish.html';
import tmpl_nds from './fSACreateAgreementEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class fSACreateAgreementEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
